%! Author = chaorn
%! Date = 01.09.24
\begin{lstlisting}[language=c,caption={Buffer Overflow in der Funktion handle__publish in der Quelldatei src/handle_publish.c des
Mosquitto Brokers},label={lst:handle_publish}]
