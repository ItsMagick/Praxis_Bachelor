...
\[
    P(\text{gültiger Fixed Header}) = \frac{1}{16} \times \frac{1}{16} = \frac{1}{256}
\]
...
\begin{multline}
    P(\text{gültiges Paket}) = P(\text{gültiger Fixed Header}) \times P(\text{gültiger Variable Header}) = \\
    \frac{1}{256}^2 \times 3.036 \times 10^{-18} \approx 3.906 \times 10^{-20}
    \approx 3.036 \times 10^{-18}
\end{multline}
