...
\newline
\textcolor{red}{hier bild von architektur einfügen}
\newline
...
Diese Zahl steigt ebenfalls stetig an, jedoch langsamer als die \quotation{pending paths}~\ref{fig:aflnet_speed}.
