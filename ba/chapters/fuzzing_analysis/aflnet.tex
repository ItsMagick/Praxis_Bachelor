...
\begin{figure}[H]
    ...
    \caption{Evaluation der Fehleranfälligkeit des \gls{zup} Mosquitto. Die Log-Datei mqtt-aflnet\_stdout.log
...
Die gefundenen Bugs nach der 48-stündigen Fuzzing-Kampagne belaufen sich auf 151 Bugs (siehe Fig.~\ref{fig:aflnet_bugs}).
Hierzu wurden alle Abstürze mithilfe eines Bash-Skripts \textcolor{red}{Hier Zitieren} dokumentiert und analysiert.
...
Dieser Buffer Overflow wird getriggert, da die Sanity-Checks in der Funktion \texttt{handle\_\_publish} auskommentiert
wurden.
...
\newline
Die anderen drei Kategorien entstammen sind gleichen Ursprungs.
Hier handelt es sich um einen Buffer Overflow in der Funktion \texttt{packet\_\_write\_bytes} in der Datei \texttt{lib\/packet\_datatypes.c}.
Diese Schwachstelle wird bei dem Senden der Nachricht an ein topic.
