...
\begin{figure}[H]
    ...
    \caption[Diagram zur Auswertung erfolgreicher Verbindungsaufbauten mit dem \gls{mqtt}-Protokoll zu Beginn der Fuzzing Kampagne]{
        ...
        10 Minuten der Fuzzing-Kampagne mit \gls{afl}Net zur Veranschaulichung der Fehleranfälligkeit zu Beginn der Fuzzing-Kampagne.
...
\begin{figure}[H]
    ...
    \caption[Diagramm zur Veranschaulichung der Ausführungsgeschwindigkeit von AFLNet während der Fuzzing-Kampagne]{Analyse der generierten Nachrichtensequenzen von \gls{afl}Net. Es wird die Anzahl der generierten Nachrichtensequenzen
...
zu überwachen.
Der Vorteil des AddressSanitizers ist, dass er Buffer Overflows, Memory Leaks, Use-after-free, Use-after-return,
Use-after-scope und Double-free Bugs erkennt und das Programm bei diesen Fehlern zu einem kontrollierten Absturz bringt~\cite{asan}.
