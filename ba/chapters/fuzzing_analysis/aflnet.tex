...
Anhand der Struktur der rohen Bytes wurden die Nachrichten in ein Format umgewandelt, das von \gls{afl}Net verstanden wird.
Hierzu wurden die Bytes der zu sendenden Nachrichten betrachtet.
