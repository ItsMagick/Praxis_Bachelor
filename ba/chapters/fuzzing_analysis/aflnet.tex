...
\end{figure}
\noindent Die grüne Linie ~\ref{fig:mqtt-aflnet_stdout} repräsentiert die Anzahl der erfolgreichen Verbindungen im Laufe der Zeit.
...
Die rote Linie~\ref{fig:mqtt-aflnet_stdout} zeigt die Anzahl der erfolglosen Verbindungen an.
...
\end{figure}
\noindent Das Diagramm~\ref{fig:mqtt-aflnet_stdout_beginning} zeigt deutlich, dass die Lernphase der State-Machine zu Beginn der Fuzzing-Kampagne von großer Bedeutung ist.
...
\end{figure}
\noindent Die Anzahl der einzigartigen Abstürze (pink~\ref{fig:aflnet_bugs}) zeigt einen kontinuierlichen Anstieg über den gesamten Kampagnenzeitraum.
