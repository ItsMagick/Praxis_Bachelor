...
\gls{afl}Net, eine Erweiterung des bekannten American Fuzzy Lop für Netzwerkschnittstellen, wird in der Literatur~\cite{afl}\cite{AFLNet}\cite{AFLplusplus-Woot20}\cite{iot-fuzzing} als ein
