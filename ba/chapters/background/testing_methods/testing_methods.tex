...
Die bekanntesten sind White-Box, Black-Box und Grey-Box Testing.
...
Der Tester kann den Quellcode der Software analysieren und die Testfälle basierend auf dem Quellcode erstellen.
...
Das Ziel dieser Testmethode ist es zunächst mögliche Eingaben von Benutzern einer Software nachzuahmen.
...
Es ist jedoch schwierig, komplexe Fehler zu finden, da der Tester keinen Zugriff auf den Quellcode hat und nicht weiß, wie die Software intern funktioniert.
...
die auf der Benutzeroberfläche basieren.
