...
Die Kommunikation erfolgt in der Regel über eine Reihe von Schritten, die als \textit{Handshake} bezeichnet werden~\cite{tcp-handshake}.
...
Das \gls{zup} verfügt über einen selbst implementierten \gls{tcp}-Server, der es ermöglicht, mit dem
