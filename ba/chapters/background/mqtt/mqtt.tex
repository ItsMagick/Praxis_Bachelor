...
Ursprünglich von Andy Stanford-Clark und Arlen Nipper entwickelt, wurde \gls{mqtt} als schlankes Protokoll konzipiert,
...
das System kann sich für ein neues Thema (Topic) abonnieren.
...
\begin{figure}[H]
    ...
    \caption{State Machine des Mosquitto MQTT-Protokolls. Sie beschreibt alle Zustände, die der Broker nach Empfangen einer
...
\end{figure}
Das zweite Diagramm zeigt eine Zustandsmaschine (State Machine) für das \gls{mqtt}-Protokoll und beschreibt den Übergang zwischen
