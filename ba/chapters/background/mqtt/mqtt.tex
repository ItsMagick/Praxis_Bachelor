...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{img/mosquitto_state_machine}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{img/mqtt_state_machine}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{img/mqtt_packet_structure}
