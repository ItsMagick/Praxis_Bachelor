...
\end{figure}
\noindent Das zweite Diagramm zeigt eine Zustandsmaschine (State Machine) für das \gls{mqtt}-Protokoll und beschreibt den Übergang zwischen
...
Die Obergrenze der Größe eines validen Nachrichtenpakets beträgt 265 Megabytes~\cite{mqtt}.