...
Generationsbasierende Fuzzer generieren Eingaben, indem sie eine Menge von Eingaben erstellen.
...
Beispielsweise ist dies Vorteilhaft, wenn besonders Komplexe Synthax des Input vonnöten ist.
\subsubsection{Mutationsbasierende Input Generierung}
Mutationsbasierende Fuzzer generieren Eingaben, indem sie vorhandene Eingaben, welche bereits im Vorfeld definiert wurden, verändern.
